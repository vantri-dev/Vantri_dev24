...
import imgPoster1 from "../img/Photo Shopping Black Friday Sale Instagram Post.png";
import imgPoster2 from "../img/Pink Gradient Summer Sale Instagram Post3.png";
export default function Slider() {
  ...
  return (
    <div className="grid grid-cols-12 w-full h-full gap-3">
      <div className=" col-span-9  w-full h-full  relative group">
        <div
      ...
      <div className="col-span-3  w-full h-full flex flex-col gap-1">
        <Link to="/cart">
        <img  className=" w-full h-40 bg-center  bg-no-repeat rounded cursor-pointer  border" src={imgPoster1} alt="" />
        </Link>
        <Link to="/">
       
            <img  className=" w-full h-40 bg-center  bg-no-repeat rounded cursor-pointer border" src={imgPoster2} alt="" />
