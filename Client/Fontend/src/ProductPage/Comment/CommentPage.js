...
import CommentUserProduct from "./CommentUserProduct";
export default function CommentPage() {
  ...
  return (
    <div className="w-full bg-white rounded">
              ...
              return (
                <div key={index} className="flex items-center w-full">
                  ...
                  <div className="w-[200px] bg-slate-200 h-2 rounded-2xl relative">
                    <div
                      className={` w-[${ratingbar.rating}] bg-violet h-2 absolute  left-0 top-0 bottom-0 rounded-2xl`}
                    ></div>
                  </div>
                  <div>
      ...
      <ul>
        <li className={fillterComment === 0 ? "block" : "hidden"}>
          <CommentUserProduct />
        </li>
      </ul>
    </div>
