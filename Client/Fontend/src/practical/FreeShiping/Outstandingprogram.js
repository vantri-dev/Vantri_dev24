      ...
      <div className="w-[1000px]   bg-white flex m-auto mt-5 flex-col justify-start pb-5">
        ...
        <div className="w-[600px] flex-wrap mt-2 pl-10">
          <p className="text-orange-500 text-[1.2rem] font-sans">
            <span className=" font-bold "> - Giảm tối đa 15.000đ</span> cho đơn
            hàng <span className=" font-bold "> trị giá 150.000đ</span> khi mua
            từ shop cùng tỉnh/thành phố
          </p>
          <p className="text-orange-500 text-[1.2rem] font-sans">
            <span className=" font-bold "> - Giảm tối đa 45.000đ</span> cho đơn
            hàng <span className=" font-bold "> trị giá 500.000đ</span> khi mua
            từ Shopteach Mall
          </p>
          <p className="text-orange-500 text-[1.2rem] font-sans">
            <span className=" font-bold "> - Giảm tối đa 10.000đ</span> cho đơn
            hàng <span className=" font-bold "> trị giá 100.000đ</span> khi mua
            từ shop khác tỉnh/thành phố
          </p>
        </div>
        <span className="px-5 pt-5   text-orange-500 text-[1.1rem] uppercase">
          Mã FreeShip XTra
        ...
        <div className="w-[600px] flex-wrap mt-2 pl-10">
          <p className="text-orange-500 text-[1.2rem] font-sans">
            - Chỉ áp dụng cho shop gắn logo
            <span className=" font-bold "> Freeship Xtra</span>
          </p>
          <p className="text-orange-500 text-[1.2rem] font-sans">
            - Miễn phí vận chuyển
            <span className=" font-bold "> - Giảm tối đa 45.000đ</span> cho đơn
            hàng <span className=" font-bold "> từ 500.000đ</span>
          </p>
          <p className="text-orange-500 text-[1.2rem] font-sans">
            - Miễn phí vận chuyển
            <span className=" font-bold "> - Giảm tối đa 10.000đ</span> cho đơn
            hàng <span className=" font-bold "> từ 50.000đ</span>
          </p>
        </div>
      </div>
