...
export default function DealShipping() {
  return (
    <>
    <div className="flex justify-center">
    <img
      className="w-[1000px] mt-[10px] "
        alt=""
        src="https://media3.scdn.vn/img4/2023/06_07/ZoDnLJmkeZH8LMSWaaeP.png"
      />
    </div>
      <img
      className="w-[1000px] mt-[100px] object-contain"
        alt=""
        src="https://media3.scdn.vn/img4/2020/03_04/tUbcyJMCE4kAPhgYVgFH.png"
      />
      <img
      className="w-[1000px] mt-[100px]  object-contain"
        alt=""
        src="https://media3.scdn.vn/img4/2023/10_13/vvhBC6YJokloHL6dDbrc.png"
      />
