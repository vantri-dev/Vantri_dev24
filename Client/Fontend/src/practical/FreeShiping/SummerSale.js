  ...
  return (
    <>
      ...
      className="w-[1000px] mt-10 h-auto"
        alt=""
        src="https://salt.tikicdn.com/cache/w1240/ts/brickv2og/04/71/92/09360d834c33a24991952de952465e70.png.webp"
      />
      ...
      <img
      className="w-[1000px] mt-[100px] h-auto"
        alt=""
        src="https://down-vn.img.susercontent.com/file/vn-50009109-a007b823d74c96b1a522d0a8e7e5de07"
      />
      <ul  className="flex items-center gap-3">
        <li >
        <div className=' col-span-1  w-full max-h-[200px]'>
